class PaymentService {
    ...
    validatePayment(params) {
        const { userPoints, totalPrice, usedPoints } = params;
    ...
    async processPayment(params) {
        const { userPoints, totalPrice, usePoints, usedPoints } = params;
        ...
        // 결제 유효성 검사 및 계산
        const paymentDetails = this.validatePayment({
            userPoints,
            totalPrice,
            usedPoints
        });
     ...
     */
    validatePointsInput(params) {
        const { userPoints, totalPrice, pointsInput } = params;
